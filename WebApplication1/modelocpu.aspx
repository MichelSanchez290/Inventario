...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Ver Marcas" />
&nbsp;
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Guardar Modelo Cpu" OnClick="Button1_Click" />
&nbsp;&nbsp;
            <asp:Button ID="Button3" runat="server" Text="Editar" OnClick="Button3_Click" style="width: 50px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Guardar Cambios" style="height: 26px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button4" runat="server" Text="Elimar" OnClick="Button4_Click" Height="33px" Width="55px" />
            <br />
            <br />
            <asp:TextBox ID="TextBox3" runat="server" Enabled="False" EnableTheming="True" Visible="False"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" Text="Ver Modelos Cpu" OnClick="Button2_Click" />
            <br />
            <br />
